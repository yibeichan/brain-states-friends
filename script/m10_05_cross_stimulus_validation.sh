#!/bin/bash
#SBATCH --job-name=m10_05_cross_valid
...
#
# Prerequisites:
#   - m10_04_score_and_decode.py completed (decoded states, FO, LL)
#   - 05a_recurrence_analysis.py completed (Friends state categories)
#   - m10_03_project_movie_pca.py completed (PCA diagnostic)
#
# Usage:
#   sbatch script/m10_05_cross_stimulus_validation.sh
#   sbatch --array=0 script/m10_05_cross_stimulus_validation.sh
#   sbatch --export=PARCELLATION=atlas-4S456Parcels script/m10_05_cross_stimulus_validation.sh
# =============================================================================
...
echo "=========================================="
echo "Movie10 Cross-Stimulus Validation"
echo "=========================================="
...
uv run --project "${PROJECT_DIR}" --no-sync python "${PROJECT_DIR}/script/m10_05_cross_stimulus_validation.py" \
    --sub_id "$SUBJECT_ID" \
