#!/bin/bash
#SBATCH --job-name=hp_03_pca_project
...
#
# Prerequisites:
#   - hp_00_postproc.sh + hp_02_extract_parcel_ts.sh completed
#   - 04_combined_hdphmm.py (mode: select) completed for this subject
#
# Usage:
#   sbatch script/hp_03_project_hp_pca.sh
#   sbatch --array=0 script/hp_03_project_hp_pca.sh          # sub-01 only
#   sbatch --export=PARCELLATION=atlas-4S456Parcels script/hp_03_project_hp_pca.sh
# =============================================================================
...
echo "=========================================="
echo "Harry Potter PCA Projection"
echo "=========================================="
...
uv run --project "${PROJECT_DIR}" --no-sync python "${PROJECT_DIR}/script/hp_03_project_hp_pca.py" \
    --sub_id "$SUBJECT_ID" \
