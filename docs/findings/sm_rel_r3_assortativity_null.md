...
Does the positive recurrence assortativity reported for the transition graph (Figure 3B; r = 0.111–0.297 across participants under a label-permutation null) survive nulls that control for the fact that recurrence is nearly the model's stationary occupancy π and that node strength on the graph is itself a function of occupancy?
...
| sub | observed | null mean | null sd | Δ | z | p (one-sided) |
|---|---|---|---|---|---|---|
| sub-01 | 0.2161 | -0.0228 | 0.0300 | 0.2389 | 7.97 | 0.0002 |
| sub-02 | 0.1430 | -0.0240 | 0.0300 | 0.1670 | 5.58 | 0.0004 |
| sub-03 | 0.1109 | -0.0229 | 0.0292 | 0.1338 | 4.59 | 0.0002 |
| sub-04 | 0.2316 | -0.0239 | 0.0305 | 0.2555 | 8.38 | 0.0002 |
| sub-05 | 0.2971 | -0.0230 | 0.0303 | 0.3201 | 10.58 | 0.0002 |
| sub-06 | 0.1220 | -0.0237 | 0.0307 | 0.1456 | 4.74 | 0.0002 |
