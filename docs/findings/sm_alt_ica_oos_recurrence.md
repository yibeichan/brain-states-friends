...
- **Model naming:** the upstream HMM whose PCA subspace and K_active value are inherited here is a finite (weak-limit, K_max=50) Gaussian-emission HMM with sticky self-transition and hierarchical-Dirichlet transition-concentration priors — not a nonparametric sticky-HDP-HMM.
